...
阶段 0 工程基线与阶段 1 的 Simulator 采集闭环已经建立。阶段 2 的代码基线已经包含真实设备 Core Motion 适配器、分传感器质量摘要、手机原始曲线、完整 NDJSON 导出，以及可重试和幂等去重的 WatchConnectivity 双文件同步代码；下一步必须在真实 Apple Watch 上完成数据质量与通信验证。
